        ...
        for rucksack in input_file:
            ...
            for item in first:
                if item in second:
                    ...
                    break
        advent_of_code.answer(1, priority_sum)


def get_priority(letter):
    ascii_ord = ord(letter)
    if ascii_ord > 90:
        return ascii_ord - 96
    else:
        return ascii_ord - 65 + 27
...
def part_2(advent_of_code):
    with open('input.txt', 'r') as input_file:
        ...
        for rucksack in input_file:
            ...
            first, second, third = rucksacks[0], rucksacks[1], rucksacks[2]
            for item in first:
                if item in second and item in third:
                    priority_sum += get_priority(item)
                    rucksacks = []
                    break
        advent_of_code.answer(2, priority_sum)
